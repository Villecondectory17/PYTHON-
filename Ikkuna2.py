...
def del_all(): 
    confirmed = tkMessageBox.askyesno("Please Comfirm", "Do you really want to delete all?")
    if confirmed == True:
...
btn_choose_random = Tkinter.Button(root, text="Choose Random", fg="green", bg="white", command=btn_choose_random)
